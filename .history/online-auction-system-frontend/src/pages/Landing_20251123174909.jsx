...
export default function Landing() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="flex-1 flex items-center py-12">
        <div className="container-wide grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block">
            <div className="w-full h-96 bg-gradient-to-tr from-slate-700 to-slate-600 rounded-3xl flex flex-col items-start justify-between p-6 shadow-2xl">
              <div className="w-full flex items-center justify-between">
                <div className="text-slate-200 text-lg font-bold">Live Auction • Vintage Watch</div>
                <div className="text-sm text-slate-300">Ends in 02:15:34</div>
              </div>

              <div className="w-full bg-white/5 rounded-lg p-4 flex items-center gap-4">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-400 to-pink-500 rounded-md" />
                <div className="flex-1">
                  <div className="text-slate-100 font-semibold">Rolex Submariner (1967)</div>
                  <div className="text-slate-300 text-sm mt-1">Current bid: <span className="text-teal-300 font-bold">$3,200</span></div>
                </div>
